...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, getRouterParam, getQuery as getQuery$1, createError, getResponseStatusText } from 'file:///Users/cheeseboiger/Documents/Work/Projects/lol-stats-reader/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/cheeseboiger/Documents/Work/Projects/lol-stats-reader/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/cheeseboiger/Documents/Work/Projects/lol-stats-reader/node_modules/devalue/index.js';
import { renderToString } from 'file:///Users/cheeseboiger/Documents/Work/Projects/lol-stats-reader/node_modules/vue/server-renderer/index.mjs';
import { renderSSRHead } from 'file:///Users/cheeseboiger/Documents/Work/Projects/lol-stats-reader/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/cheeseboiger/Documents/Work/Projects/lol-stats-reader/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///Users/cheeseboiger/Documents/Work/Projects/lol-stats-reader/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///Users/cheeseboiger/Documents/Work/Projects/lol-stats-reader/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/cheeseboiger/Documents/Work/Projects/lol-stats-reader/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file:///Users/cheeseboiger/Documents/Work/Projects/lol-stats-reader/node_modules/scule/dist/index.mjs';
import { klona } from 'file:///Users/cheeseboiger/Documents/Work/Projects/lol-stats-reader/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/cheeseboiger/Documents/Work/Projects/lol-stats-reader/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///Users/cheeseboiger/Documents/Work/Projects/lol-stats-reader/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file:///Users/cheeseboiger/Documents/Work/Projects/lol-stats-reader/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/cheeseboiger/Documents/Work/Projects/lol-stats-reader/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/cheeseboiger/Documents/Work/Projects/lol-stats-reader/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/cheeseboiger/Documents/Work/Projects/lol-stats-reader/node_modules/radix3/dist/index.mjs';
import { fileURLToPath } from 'node:url';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file:///Users/cheeseboiger/Documents/Work/Projects/lol-stats-reader/node_modules/ipx/dist/index.mjs';
import { isAbsolute } from 'file:///Users/cheeseboiger/Documents/Work/Projects/lol-stats-reader/node_modules/pathe/dist/index.mjs';
import { version, unref } from 'file:///Users/cheeseboiger/Documents/Work/Projects/lol-stats-reader/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Users/cheeseboiger/Documents/Work/Projects/lol-stats-reader/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/cheeseboiger/Documents/Work/Projects/lol-stats-reader/node_modules/@unhead/shared/dist/index.mjs';
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    "apiBase": "api.riotgames.com",
    "avatarBase": "http://ddragon.leagueoflegends.com/cdn/13.20.1/img/profileicon/",
    "championBase": "http://ddragon.leagueoflegends.com/cdn/13.20.1/img/champion/",
    "itemBase": "http://ddragon.leagueoflegends.com/cdn/13.20.1/img/item/",
    "spellBase": "http://ddragon.leagueoflegends.com/cdn/13.20.1/img/spell/",
    "runeBase": "http://ddragon.leagueoflegends.com/cdn/img/"
  },
  "apiKey": "RGAPI-e658a083-bc04-4d00-975b-36926b1e0068",
  "ipx": {
    "baseURL": "/_ipx",
    "alias": {},
    "fs": {
      "dir": "/Users/cheeseboiger/Documents/Work/Projects/lol-stats-reader/public"
    },
    "http": {
      "domains": []
    }
...
const serverAssets = [{"baseName":"server","dir":"/Users/cheeseboiger/Documents/Work/Projects/lol-stats-reader/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/cheeseboiger/Documents/Work/Projects/lol-stats-reader","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/cheeseboiger/Documents/Work/Projects/lol-stats-reader/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/cheeseboiger/Documents/Work/Projects/lol-stats-reader/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/cheeseboiger/Documents/Work/Projects/lol-stats-reader/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/cheeseboiger/Documents/Work/Projects/lol-stats-reader/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _UlwpZqSgtx = (function(nitro) {
...
const getMatchHistory = (region, puuid) => {
...
const isValidRegion = (region) => region in platformCodes;

const _EtnoLk = lazyEventHandler(() => {
...
const _lazy_48iq3u = () => Promise.resolve().then(function () { return _name_$1; });
const _lazy_vuVzHu = () => Promise.resolve().then(function () { return _id_$1; });
const _lazy_fdPCk9 = () => Promise.resolve().then(function () { return _puuid_$1; });
const _lazy_zOlWNB = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/:region/summoner/:name', handler: _lazy_48iq3u, lazy: true, middleware: false, method: undefined },
  { route: '/:region/summoner/match/:id', handler: _lazy_vuVzHu, lazy: true, middleware: false, method: undefined },
  { route: '/:region/summoner/match/history/:puuid', handler: _lazy_fdPCk9, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_zOlWNB, lazy: true, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _EtnoLk, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_zOlWNB, lazy: true, middleware: false, method: undefined }
];
...
const _puuid_$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: _puuid_
});
...
const getClientManifest = () => import('file:///Users/cheeseboiger/Documents/Work/Projects/lol-stats-reader/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/cheeseboiger/Documents/Work/Projects/lol-stats-reader/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
