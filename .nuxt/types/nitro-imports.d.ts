declare global {
  ...
  const getMatchById: typeof import('../../server/utils/helpers')['getMatchById']
  const getMatchHistory: typeof import('../../server/utils/helpers')['getMatchHistory']
  ...
  const getSummonerByName: typeof import('../../server/utils/helpers')['getSummonerByName']
  ...
  const isValidRegion: typeof import('../../server/utils/helpers')['isValidRegion']
...
declare global {
  // @ts-ignore
  export type { PlatformCodesType } from '/Users/cheeseboiger/Documents/Work/Projects/lol-stats-reader/server/utils/types.ts'
}
...
export { getSummonerByName, getMatchHistory, getMatchById, isValidRegion } from '../../server/utils/helpers';